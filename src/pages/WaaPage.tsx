  ...
  return (
    ...
    >
      ...
      <div className="flex md:hidden flex-col min-h-screen w-full overflow-hidden">
        ...
        <div className="fixed top-0 left-0 w-screen h-[15vh] bg-white shadow-md z-50 flex items-center px-4 space-x-8">
          <img 
            src="https://i.postimg.cc/QN5wkj2k/unnamed.webp" 
            alt="waa logo" 
        ...
        <div className="flex-none h-[40vh] flex relative z-10 px-4 pt-[25vh]">
          {/* Boutons empilés à droite */}
          <div className="w-full md:w-[35%] flex flex-col justify-center items-center space-y-8">
            <Button 
              variant="outline"
              className="hover:scale-105 transition-transform duration-200 ml-4 w-25 bg-black text-white border-none flex items-center justify-center gap-2 h-10 rounded-full hover:bg-gray-800 transition-colors text-xs"
              onClick={() => window.open("https://play.google.com/store/apps/details?id=bj.sbin.mobilemoney.customer&hl=en", "_blank")}
            >
              <img
                src="https://i.postimg.cc/76qkVFRp/google-play-3128279.png"
        ...
        <div className="h-[15vh] flex-1 overflow-y-auto px-4 py-6 text-center text-xs leading-relaxed font-waa pt-[15vh]">
          <p className="max-w-full font-waa">
            Waa est la nouvelle super app de Celtiis qui remplace l'application MyCeltiis Cash. Elle regroupe tous les services de cette dernière avec plein d'autres innovations à l'instar de l'E-Commerce ; Le Ticketing - Scolarité - MyCeltiis - Près de moi...
          </p>
        </div>
        <div className="fixed bottom-0 left-0 w-screen h-[10vh] bg-white shadow-inner z-50 flex items-center justify-center px-4 text-xs font-waa" />
      </div>
    </div>
  );
};
