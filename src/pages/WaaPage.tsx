  ...
  return (
    ...
    >
      ...
      <div className="flex md:hidden flex-col min-h-screen w-full overflow-hidden">
        ...
        <div className="flex-none h-[55vh] flex relative z-10 px-4">
        ...
        <div className="h-[15vh] flex-1 overflow-y-auto px-4 py-6 text-center text-xs leading-relaxed font-waa pb-[10vh]">
