...
const WaaPage = () => {
  return (
    <div className="min-h-screen w-full bg-white flex flex-col md:flex-row">
      ...
      <div className="w-full md:w-1/2 py-4 md:py-20 px-6 md:px-20 flex flex-col gap-20">
        {/* Logo en haut */}
        ...
        {/* Boutons de téléchargement juste en dessous du texte */}
        <div className="flex flex-wrap gap-4 mt-4 md:mt-6">
          <Button 
            variant="outline"
            className="w-full md:w-auto md:min-w-[220px] bg-[#000000] text-white border-none flex items-center justify-center gap-2 h-12 rounded-full px-6"
