    ...
    >
      ...
      <div className="flex md:hidden flex-col min-h-screen">
        ...
        <div className="flex-none h-[45vh] flex relative z-10 px-4">
          ...
          <div className="w-full md:w-[25%] flex flex-col justify-center items-center space-y-8">
            <Button 
              variant="outline"
          ...
          <div className="w-full md:w-[70%] flex flex-col items-center justify-center relative">
            <img 
              src="https://i.postimg.cc/9QDHmGGh/Waa.png" 
              alt="Interface waa" 
              className="object-contain h-64 max-w-full z-10 animate-zoom-slow"
