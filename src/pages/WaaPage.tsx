    ...
    >
      ...
      <div className="hidden md:flex flex-col h-full">
        ...
        <div className="flex flex-row justify-between items-center space-y-0 h-[20%] relative z-10">
          ...
          />
          <h1 className="text-sm font-light flex-1 font-waa animate-pulse text-[#B2C248]">Il est temps de passer à {"  "}<span className="px-3 py-1 rounded-xl font-semibold shadow-[0_0_10px_#A9C01C] text-black animate-pulse" style={{ background: "#A9C01C"}}>Waa.</span></h1>
        </div>
